""" Python module containing helper functions for mplkorfball."""
# Authors: Anmol_Durgapal(@slothfulwave612), Andrew Rowlinson (@numberstorm), Andrew Bovey (@korfdata)
...
class Standardizer:
    ...
    Examples
    --------
    >>> from mplkorfball import Standardizer
    >>> standard = Standardizer(pitch_from='fullsize', pitch_to='custom',
    ...                         length_to=30.50, width_to=15.25)
    >>> x = [20, 30]
    >>> y = [50, 80]
