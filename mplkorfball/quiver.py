"""`mplkorfball.quiver` is a python module containing a function to plot arrows in
...
class HandlerQuiver(HandlerLine2D):
    """Automatically generated by mplkorfball's arrows() to allow use of arrows in legend.
    """
